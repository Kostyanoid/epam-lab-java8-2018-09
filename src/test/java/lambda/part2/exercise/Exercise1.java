...
//        throw new UnsupportedOperationException("Not implemented");
    ...
    // TODO - возвращающий BiFunction, сравнивающий два объекта Person и возвращающий возраст того, чье полное имя длиннее.
     private static BiFunction<Person, Person, Integer> createExtractorAgeOfPersonWithTheLongestFullName(Function<Person, String> fullNameGetter) {
        Function<Person, Integer> getFullNameLength= p -> fullNameGetter.apply(p).length();
        return (p1, p2) -> Comparator.comparingInt(getFullNameLength::apply).compare(p1, p2) > 0 ? p1.getAge() : p2.getAge();
     }
